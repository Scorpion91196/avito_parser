...
def write_csv(data):
    with open('motherboards.csv', 'a', encoding='utf8') as f:
        writer = csv.writer(f)
...
@second_thread
def start_motherboards_parser(signal, status_bar_signal, request_target_gui):
    time_start = time.time()
    global pool
    pool = ThreadPool(20)

    base_url = 'https://www.avito.ru/tomsk/tovary_dlya_kompyutera/komplektuyuschie/materinskie_platy?'
    base_part = 'p='
    date_filter = '&s=104'
    price_max = '&pmax=10000'
    price_min = '&pmin=0'
