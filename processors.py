...
def write_csv(data):
    with open('processors.csv', 'a', encoding='utf8') as f:
        writer = csv.writer(f)
...
@second_thread
def start_processors_parser(signal, status_bar_signal, request_target_gui):
    time_start = time.time()
    global pool
    pool = ThreadPool(10)

    base_url = 'https://www.avito.ru/tomsk/tovary_dlya_kompyutera/komplektuyuschie/protsessory?'
    base_part = 'p='
    date_filter = '&s=104'
